...
<div class="h-[780px] bg-white rounded-lg outline outline-2 outline-offset-[-2px] outline-gray-300 inline-flex flex-col justify-start items-start overflow-hidden">
  <div class="w-96 h-[780px] relative bg-orange-50 border-gray-200">
    ...
    <div class="w-48 h-48 left-[260px] top-[140px] absolute opacity-58 bg-emerald-200 rounded-full blob-float"></div>
    <div class="w-64 h-64 left-[-25px] top-[30px] absolute opacity-55 bg-lime-100 rounded-full blob-float-2"></div>
    <div class="w-56 h-56 left-[280px] top-[580px] absolute opacity-60 bg-teal-200 rounded-full blob-float-3"></div>
    <div class="w-40 h-40 left-[-15px] top-[520px] absolute opacity-58 bg-green-100 rounded-full blob-float"></div>
      ...
      <div class="w-96 h-[780px] left-0 top-0 absolute bg-black/0 border-gray-200">
        ...
        <div class="w-80 h-28 left-[24px] top-[604px] absolute bg-black/0 border-gray-200">
          <div class="w-80 h-80 left-0 top-[-397px] absolute bg-orange-50 rounded-2xl shadow-[0px_10px_15px_0px_rgba(0,0,0,0.10)] shadow-[0px_4px_6px_0px_rgba(0,0,0,0.10)] outline outline-2 outline-offset-[-2px] outline-yellow-100">
            <div class="w-72 left-[23px] top-[37px] absolute text-center justify-start text-black text-3xl font-light font-['Outfit']">Se ha completado el registro.</div>
            <div class="w-72 h-36 left-[21px] top-[145px] absolute text-center justify-start text-stone-700 text-xl font-light font-['Outfit']">Bienvenid@ {{ session('nuevo_usuario', 'tu usuario') }}, ahora comienza tu experiencia en Loom</div>
          </div>
        </div>
      </div>
    </div>
