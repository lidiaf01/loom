...
function validarClave(clave) {
    ...
    if (!/[a-z]/.test(clave)) {
        return 'La clave debe contener al menos una minúscula';
    }
...
// ============================================
function validarConfirmarClave(clave, confirmarClave) {
    if (!confirmarClave || confirmarClave === '') {
        return 'Debes confirmar tu clave';
    }
...
function validarFormularioLogin() {
    ...
    // Validar clave
    if (!clave || clave === '') {
        mostrarError('clave', 'La clave es requerida');
        esValido = false;
    } else {
        limpiarError('clave');
    }
