...
<main class="auth-container">
    <div class="auth-form-wrapper">
        ...
        <form id="formLogin" class="auth-form" method="POST" action="/loom/controladores/auth_router.php">
            ...
            <div class="form-footer">
                <p>¿No tienes cuenta? <a href="<?php echo url('vistas/autenticacion/registro.php'); ?>" class="link-registro">Regístrate aquí</a></p>
            </div>
        </form>
